                    ...
                    <div class="box box-success">
                        <div class="box-header">
                            <div class="col-md-12 text-center">
                                <img src="<?= base_url() . $_SESSION['AccountantPhoto']; ?>" class="img-circle"
                                     alt="User Image"><br>
                                <h3>Your LoginID is : <span
                                            class="btn btn-success"><?= $_SESSION['cashier_username'] ?></span></h3>

                                <h3>Accountant Name : <?= $_SESSION['AccountantName'] ?></h3>
                                <h3>Contact Number: <?= $_SESSION['AccountantContact'] ?></h3>
