            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Fee Allocation updated successfully';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="category" class="form-control">
                                    ...
                                    if (isset($categories)) {
                                        foreach ($categories as $c) {
                                            if ($c['CategoryID'] == $allocation[0]['CategoryID'])
                                ...
                                <input name="amount" type="text" value="<?= $allocation[0]['Amount'] ?>"
                                       class="form-control"><br>
                            </div>
                            <div class="col-lg-6">
                                <label>Select Class</label>
                                <input name="class" value="<?= $class ?>" disabled class="form-control"><br/>
                            ...
                            <div class="col-lg-12">
                                <input type="submit" value="Update Allocate Fee" class="btn btn-success pull-right">
                    ...
                    if (!empty($allocations)) { ?>
                        ...
                        <table class="table table-striped mt-4">
                            ...
                            <?php foreach ($allocations as $c) {
                                ...
                                $url = site_url('FeeController/edit_allocate_fee/' . $c["ClassID"]);
                                echo '<td><a href="' . $url . '">';
