    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-5 mb-5">
                ...
                <h3>Planner Downloads Section</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 pl-4 pr-4" style="padding: 20px 0;background-color: #eeeced">
                ...
                <h4 class="mb-3"><i class="fa fa-search"></i> Find Planner</h4>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table table-active table-bordered table-hover mt-4">
                            ...
                            <?php foreach ($planners as $c) {
                                ...
                                $url = site_url('DownloadFiles/download_planner/' . $c["PlannerID"]);
...
<script src="<?= base_url(); ?>/assets/js/getPlanners.js"></script>
