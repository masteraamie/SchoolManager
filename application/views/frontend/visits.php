            ...
            if (isset($visits)) {
                foreach ($visits as $a) {
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="<?= base_url('view_visit/' . $a['VisitID']) ?>"
                           class="mt-3 mb-1"><?= $a['Title'] ?></a>
                        ...
                        <a href="<?= base_url('view_visit/' . $a['VisitID']) ?>" class="btn btn-sm btn-success mb-4"
