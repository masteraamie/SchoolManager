    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-5 mb-5">
                ...
                <h3>Syllabus Downloads Section </h3>

            </div>

        </div>

        <h4 class="mb-3"><i class="fa fa-search"></i> Find Syllabus</h4>
            ...
            <div class="col-lg-12">
                ...
                <table class="table table-active table-bordered table-hover mt-4">
                    ...
                    <?php foreach ($syllabi as $c) {
                        ...
                        $url = site_url('DownloadFiles/download_syllabus/' . $c["SyllabusID"]);
...
<script src="<?= base_url(); ?>/assets/js/getSyllabi.js"></script>
