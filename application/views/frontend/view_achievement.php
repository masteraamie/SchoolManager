            ...
            if (isset($achievement)) {
                ...
                <div class="col-lg-12 mt-5 mb-5">
                    ...
                    if ($achievement[0]['Image'] != "") {
                        echo '<img src="' . base_url() . $achievement[0]['Image'] . '" class="img-fluid">';
                    } else {
                    ...
                    <br/>
                    <br/>
                    <a href="" class="mt-3 mb-1"><?= $achievement[0]['Title'] ?></a>
                    <br/>
                    <br/>
                    <h5>Achievement Date </h5>
                    <i class="fa fa-calendar"></i> <?php
                    $date = date_create($achievement[0]['Date']);
