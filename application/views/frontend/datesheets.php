    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-5 mb-5">
                ...
                <h3>Datesheet Downloads Section</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 pl-4 pr-4" style="padding: 20px 0;background-color: #eeeced">
                ...
                <h4 class="mb-3"><i class="fa fa-search"></i> Find Date Sheet</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table table-active table-bordered table-hover mt-4">
                            ...
                            <tbody id="table_body">
                            <?php foreach ($datesheets as $c) {
                                echo "<tr>";

                                echo "<td>";
                                $date = date_create($c['DOE']);
                                echo date_format($date, "d M Y");
                                echo "</td>";
                                echo "<td><a href='" . base_url("FrontendController/view_datesheet/" . $c['DatesheetID']) . "'>";
                                echo $c['Title'];
                                echo "</a></td>";
                                ...
                                $url = site_url('DownloadFiles/download_datesheet/' . $c["DatesheetID"]);
...
<script src="<?= base_url(); ?>assets/js/getDatesheets.js"></script>
