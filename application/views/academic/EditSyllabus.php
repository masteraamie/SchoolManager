            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Syllabus Edited successfully .</span>';
                        echo '</p>';
                    }
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row mt-4">
                    ...
                    <div class="box box-success">
                        <div class="box-header"><h3 class="box-title">Syllabus Details</h3></div>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <input name="title" type="text" value="<?= $syllabus[0]['Title'] ?>"
                                       class="form-control"><br>


                                <div class="form-group">
                                    <label for="exampleInputFile">Syllabus Attachment</label>
                                ...
                                <select id="class" name="class" class="form-control">
                                    ...
                                    if (isset($classes)) {
                                        foreach ($classes as $c) {
                                            if ($syllabus[0]['ClassID'] == $c['ClassID'])
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Edit Syllabus" type="submit" class="btn btn-success pull-right">
