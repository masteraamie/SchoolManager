                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <textarea name="description" class="form-control"
                                          rows="10"><?= $assignment['Description'] ?></textarea><br>
                    ...
                    if (!empty($assignments)) { ?>
                        ...
                        <table class="table table-striped mt-4">
                            ...
                            <?php foreach ($assignments as $c) {
                                ...
                                $url = site_url('TeacherController/edit_assignment/' . $c["AssignmentID"]);
                                echo '<td><a href="' . $url . '">';
                                echo '<i class="fa fa-eye"></i>';
                                echo "</a></td>";

                                $url = site_url('TeacherController/delete_assignment/' . $c["AssignmentID"]);
