    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Planner</li>
            </ol>
        </section>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Planner added successfully .</span>';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <input name="title" type="text" value="<?= $planner['Title'] ?>"
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Add Planner" type="submit" class="btn btn-success pull-right">
