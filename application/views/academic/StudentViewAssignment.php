                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <h3><?= $assignment[0]['Title'] ?></h3><br>


                                <label>Assignment Submission Date : <?= $assignment[0]['DOS'] ?></label>
                                <br>
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php if (isset($assignment[0]['File'])) {
                                    $download = site_url('DownloadFiles/download_assignment/' . $assignment[0]['AssignmentID']);
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <h6><?= $assignment[0]['Description'] ?></h6><br>
                                </div>
