            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Book updated successfully .</span>';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <label>Book ID</label>
                                <input name="book_id" type="text" value="<?= $book[0]['BookID'] ?>" class="form-control"
                                       disabled><br>


                                <label>Book Name</label>
                                <input name="name" type="text" value="<?= $book[0]['Name'] ?>" class="form-control"><br>
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    if ($book[0]['Status'] == 0) {
                                        echo '<option selected value="0">Available</option>';
                                        echo '<option value="1">Issued</option>';
                                    } else {
                                        echo '<option selected value="1">Issued</option>';
                                ...
                                <select name="student" class="form-control select2" style="width: 100%;">
                                    ...
                                    if (isset($students)) {
                                        ...
                                        foreach ($students as $s) {
                                            if ($students['RegistrationNumber'] == $book['RegistrationNumber'])
                                                echo '<option selected value="' . $s["RegistrationNumber"] . '">';
                                            else
                                                echo '<option value="' . $s["RegistrationNumber"] . '">';
                                            echo $s['RegistrationNumber'];
                                            echo '</option>';
                                        }
                                    } else {
                                        echo '<option value="0">';
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="dor" type="date" value="<?= $book[0]['DOReg'] ?>" class="form-control"><br>


                                <label>Issue Date</label>
                                <input name="doissue" type="date" value="<?= $book[0]['DOIssue'] ?>"
                                       class="form-control"><br>


                                <label>Return Date</label>
                                <input name="doret" type="date" value="<?= $book[0]['DORet'] ?>"
                                       class="form-control"><br>
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Update Book" type="submit" class="btn btn-success pull-right">
