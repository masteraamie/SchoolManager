            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Class added successfully';
                        echo '</p>';
                    }
            ...
            <form action="" method="post">
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input name="percent" type="number" class="form-control"><br>

                    </div>

                    <div class="col-lg-12 mt-3">

                        <input value="Add Class" type="submit" class="btn btn-success pull-right">
