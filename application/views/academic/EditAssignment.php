            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Assignment updated successfully .</span>';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <input name="title" type="text" value="<?= $assignment[0]['Title'] ?>"
                                       class="form-control"><br>


                                <label>Date of Submission</label>
                                <input name="dos" type="date" value="<?= $assignment[0]['DOS'] ?>" class="form-control"><br>
                                ...
                                <select id="class" name="class" class="form-control">
                                    ...
                                    if (isset($classes)) {
                                        foreach ($classes as $c) {
                                            if ($c['ClassID'] == $assignment[0]['ClassID'])
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <div class="form-group">
                                    <textarea name="description" id="compose-textarea"
                                              class="form-control"
                                              style="height: 300px"><?= $assignment[0]['Description'] ?></textarea>
                                </div>
                                <br/>
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Update Assignment" type="submit" class="btn btn-success pull-right">
