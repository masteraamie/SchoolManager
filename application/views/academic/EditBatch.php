            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Batch updated successfully';
                        echo '</p>';
                    }
            ...
            <form action="" method="post">
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input name="year" type="number" value="<?= $batch[0]['Year'] ?>" class="form-control"><br>
                        <input value="Update Batch" type="submit" class="btn btn-success pull-right">
                    </div>
                </div>
            </form>
            <!--FORM-->
