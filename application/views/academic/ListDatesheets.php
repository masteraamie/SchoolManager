    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Date Sheet List</li>
            </ol>
        </section>
                    ...
                    if (!empty($datesheets)) {
                        ...
                        <table class="table table-striped mt-4">
                            ...
                            <?php foreach ($datesheets as $c) {
                                ...
                                $url = site_url('AcademicController/edit_datesheet/' . $c["DatesheetID"]);
                                echo '<td><a href="' . $url . '">';
                                echo '<i class="fa fa-eye"></i>';
                                echo "</a></td>";

                                $url = site_url('AcademicController/delete_datesheet/' . $c["DatesheetID"]);
