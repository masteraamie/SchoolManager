            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Syllabus added successfully .</span>';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <input name="title" type="text" value="<?= $syllabus['Title'] ?>"
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Add Syllabus" type="submit" class="btn btn-success pull-right">
