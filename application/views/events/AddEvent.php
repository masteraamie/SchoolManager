            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Event added successfully';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input name="start_date" value="<?= $event['StartDate'] ?>" type="date"
                                       class="form-control"><br>

                                <label>Event End Date</label>
                                <input name="end_date" type="date" value="<?= $event['EndDate'] ?>"
                                       class="form-control"><br>

                                <label>Organiser Name</label>
                                <input name="organiser" value="<?= $event['Organiser'] ?>" type="text"
                                       class="form-control"><br>
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input type="submit" value="Add Event" class="btn btn-success pull-right">
