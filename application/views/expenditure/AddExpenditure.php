                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" value="<?= $expenditure['Name'] ?>"
                                       class="form-control">


                                <br/>
                                <label>Expenditure Amount ( in Rupees )</label>
                                <input name="amount" type="number" value="<?= $expenditure['Amount']; ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="date" name="date" value="<?= $expenditure['Date'] ?>"
                                           class="form-control">
                                </div>
                                <br>
                                ...
                                <input name="cheque" id="cheque" disabled type="text" class="form-control"><br>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <textarea name="details" placeholder="Expenditure Details" id="compose-textarea"
                                              class="form-control"
                                              style="height: 300px"><?= $expenditure['Details'] ?></textarea>
                                </div>

                                <input type="submit" name="submit" value="Add Expenditure"
