...
<div class="wrapper">
    ...
    <?php $this->load->view('cashier_sidebar'); ?>
                    ...
                    <div class="box box-success">
                        <div class="box-header">
                            <div class="col-md-12 text-center">
                                <img src="<?= base_url() . $_SESSION['CashierPhoto']; ?>" class="img-circle"
                                     alt="User Image"><br>
                                <h3>Your LoginID is : <span
                                            class="btn btn-success"><?= $_SESSION['cashier_username'] ?></span></h3>

                                <h3>Cashier Name : <?= $_SESSION['CashierName'] ?></h3>
                                <h3>Contact Number: <?= $_SESSION['CashierContact'] ?></h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="old_pass" type="password" class="form-control"><br>
