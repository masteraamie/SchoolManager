                                        ...
                                        <div class="sc_price_block sc_price_block_style_2 width_100per">
                                            <marquee direction="up" onmouseover="stop();" onmouseout="start();"
                                                ...
                                                <ul>
                                                    ...
                                                    if (isset($news)) {
                                                        foreach ($news as $e) {
                                                            echo '<li><a href="' . base_url() . 'AccountantController/view_news/' . $e["NewsID"] . '">';
                                        ...
                                        <div class="sc_price_block sc_price_block_style_2 width_100per">
                                            <marquee direction="up" onmouseover="stop();" onmouseout="start();"
                                                ...
                                                <ul>
                                                    ...
                                                    if (isset($events)) {
                                                        foreach ($events as $e) {
                                                            echo '<liclass="btn btn-block"><h3><a href="' . base_url() . 'AccountantController/view_event/' . $e["EventID"] . '">';
                                        ...
                                        <div class="sc_price_block sc_price_block_style_2 width_100per">
                                            <marquee direction="up" onmouseover="stop();" onmouseout="start();"
                                                ...
                                                <ul>
                                                    ...
                                                    if (isset($visits)) {
                                                        foreach ($visits as $e) {
                                                            echo '<li class="btn btn-block"><h3><a href="' . base_url() . 'AccountantController/view_visit/' . $e["VisitID"] . '">';
                                                            echo $e['Title'] . " on " . $e['Date'];
                                                            echo "</a></h3></li>";
                                                        }
                                                    } else {
