            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row mt-4">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Get Employees" type="button" id="btn_get"
                    ...
                    <div id="box_attendance" hidden class="box box-success">
                        <div class="box-header"><h3 class="box-title">Employee List</h3></div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input value="Do Attendance" type="button" id="btn_attend"
                                       class="btn btn-success pull-right">
...
<script src="<?= base_url(); ?>assets/js/loadEmployeesAttendance.js"></script>
<!-- Bootstrap 3.3.6 -->
