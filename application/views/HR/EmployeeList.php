        ...
        <section class="content">
            ...
            <form action="" method="post">
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input id="viewPay" value="View Employee List" type="button" class="btn btn-success pull-right">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <table id="table" hidden class="table table-striped mt-4">
                        <thead>
                        <tr>
                            <th>Employee ID</th>
                            <th>Employee Name</th>
...
<script src="<?= base_url(); ?>assets/js/loadEmployees.js"></script>
<!-- Bootstrap 3.3.6 -->
