                    ...
                    <div class="box box-success">
                        <div class="box-header">
                            <div class="col-md-12 text-center">
                                <img src="<?= base_url() . $_SESSION['TeacherPhoto']; ?>" class="img-circle"
                                     alt="User Image"><br>
                                <h3>Your LoginID is : <span
                                            class="btn btn-success"><?= $_SESSION['teacher_username'] ?></span></h3>

                                <h3>Teacher Name : <?= $_SESSION['TeacherName'] ?></h3>
                                <h3>Contact Number: <?= $_SESSION['TeacherContact'] ?></h3>
