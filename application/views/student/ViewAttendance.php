                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input id="student" name="student" type="hidden"
                                                   value="<?= $_SESSION['StudentID'] ?>" class="form-control">
                                            <input name="student" disabled
...
<script src="<?= base_url(); ?>assets/js/viewStudentAttendance.js"></script>
<!-- Bootstrap 3.3.6 -->
