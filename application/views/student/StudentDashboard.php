            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Days Absent this Month</span>
                            <span class="info-box-number"><?= $absents ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Days Present this Month</span>
                            <span class="info-box-number"><?= $presents ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                                        ...
                                        <div class="sc_price_block sc_price_block_style_2 width_100per">
                                            <marquee direction="up" onmouseover="stop();" onmouseout="start();"
                                                ...
                                                <ul>
                                                    ...
                                                    if (isset($news)) {
                                                        foreach ($news as $e) {
                                                            echo '<li><a href="' . base_url() . 'StudentDashboard/view_news/' . $e["NewsID"] . '">';
                                        ...
                                        <div class="sc_price_block sc_price_block_style_2 width_100per">
                                            <marquee direction="up" onmouseover="stop();" onmouseout="start();"
                                                ...
                                                <ul>
                                                    ...
                                                    if (isset($events)) {
                                                        foreach ($events as $e) {
                                                            echo '<li class="btn btn-block"><h4><a href="' . base_url() . 'TeacherController/view_event/' . $e["EventID"] . '">';
                                        ...
                                        <div class="sc_price_block sc_price_block_style_2 width_100per">
                                            <marquee direction="up" onmouseover="stop();" onmouseout="start();"
                                                ...
                                                <ul>
                                                    ...
                                                    if (isset($visits)) {
                                                        foreach ($visits as $e) {
                                                            echo '<li class="btn btn-block"><h4><a href="' . base_url() . 'TeacherController/view_visit/' . $e["VisitID"] . '">';
                                                            echo $e['Title'] . " on " . $e['Date'];
                                                            echo "</a></h4></li>";
                                                        }
                                                    } else {
