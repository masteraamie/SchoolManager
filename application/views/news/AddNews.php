            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> News added successfully';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <label>News By</label>
                                <input name="news_by" value="<?= $news['NewsBy'] ?>" type="text"
                                       class="form-control"><br>
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <div class="form-group">
                                    <textarea name="details" id="compose-textarea" class="form-control"
                                              style="height: 300px"><?= $news['Details'] ?></textarea>
                                </div>
                                <input type="submit" value="Add News" class="btn btn-success pull-right">
