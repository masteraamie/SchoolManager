    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Stop Allocation</li>
            </ol>
        </section>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Stop allocated successfully .</span>';
                        echo '</p>';
                    }
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row mt-4">
                    ...
                    <div class="box box-success">
                        <div class="box-header"><h3 class="box-title">Allocation Details</h3></div>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <select name="stop" class="form-control">
                                    ...
                                    if (isset($stops)) {
                                        echo '<option value="0">';
                                        echo "Remove Allocation";
                                        echo "</option>";
                                        foreach ($stops as $c) {
                                            echo '<option value="' . $c["StopID"] . '">';
                                            echo $c['Name'];
                                            echo "</option>";
                                        }
                                    }
