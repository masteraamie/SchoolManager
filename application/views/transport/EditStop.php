    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Update Stop</li>
            </ol>
        </section>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($success)) {
                        ...
                        echo '<i class="fa fa-check-circle"></i> Stop updated successfully .</span>';
                        echo '</p>';
                    }
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <input name="name" value="<?= $stop[0]['Name'] ?>" type="text"
                                       placeholder="e.g Stop No 1" class="form-control"><br>


                                <input value="Update Stop" type="submit" class="btn btn-success pull-right">
