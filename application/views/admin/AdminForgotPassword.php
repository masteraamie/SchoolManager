...
<body>
<div class="container">
    <a href="<?= site_url("TeacherLogin/") ?>"><input type="button" value="Teacher Login" class="btn btn-primary"
                                                      style="margin-top: 20px;border-radius: 0"></a>
    <a href="<?= site_url("StudentLogin/") ?>"><input type="button" value="Student Login" class="btn btn-primary"
                                                      style="margin-top: 20px;border-radius: 0"></a>
