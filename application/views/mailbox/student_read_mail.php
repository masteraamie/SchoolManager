                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <div class="mailbox-read-info">
                                ...
                                <h5>From: <?php
                                    ...
                                    if ($message[0]['AdminID'] != '0')
                                        echo $message[0]['AdminID'];
                                    elseif ($message[0]['SenderTeacherID'] != '0')
                        ...
                        <?php if (isset($assignment[0]['File'])) {
                            $download = site_url('DownloadFiles/download_student_attachment/' . $message[0]['MessageID']);
