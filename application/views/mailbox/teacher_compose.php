...
<head>
    ...
    <title>Teacher | Compose Message</title>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input name="receiver" value="<?= $receiver ?>" class="form-control"
                                           placeholder="To: Enter LoginID of Receiver">
                                </div>
                                <div class="form-group">
                                    <input name="subject" value="<?= $message['Subject'] ?>" class="form-control"
                                           placeholder="Subject:">
                                </div>
                                <div class="form-group">
                                    <textarea name="message" id="compose-textarea" class="form-control"
                                              style="height: 300px"><?= $message['Message'] ?></textarea>
                                </div>
                            </div>
                            <!-- /.box-body -->
